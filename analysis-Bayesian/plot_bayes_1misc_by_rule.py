...
2. **The excluded band is drawn.** Anything above 0.35 is shaded, because no
   category-B item ever probes a foil in that band. On the 5-op pool four rules
   never enter it and sub<÷ enters it once, while `outside_bracket_first` enters
   it on 19 of its 200 absent traces. That asymmetry is the point.
